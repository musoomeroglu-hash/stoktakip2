...
export const SEGMENT_CONFIG: Record<CustomerSegment, { label: string; color: string; icon: string }> = {
    vip: { label: 'VIP', color: 'bg-purple-500/20 text-purple-300 border-purple-500', icon: '👑' },
    frequent: { label: 'Düzenli', color: 'bg-blue-500/20 text-blue-300 border-blue-500', icon: '⭐' },
    regular: { label: 'Standart', color: 'bg-slate-500/20 text-slate-300 border-slate-500', icon: '👤' },
    new: { label: 'Yeni', color: 'bg-green-500/20 text-green-300 border-green-500', icon: '🎁' },
    inactive: { label: 'Pasif', color: 'bg-red-500/20 text-red-300 border-red-500', icon: '😴' },
};
