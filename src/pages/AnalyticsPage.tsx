            ...
            <div className="bg-surface-dark border border-slate-700/50 rounded-xl p-6">
                ...
                <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={dailyTrend}>
                        ...
                        <YAxis stroke="var(--color-text-secondary)" fontSize={11} tickFormatter={v => `₺${(v / 1000).toFixed(0)}k`} />
                        <Tooltip
                            contentStyle={{ background: 'var(--color-surface-dark)', border: '1px solid var(--color-border)', borderRadius: '8px', fontSize: '12px', color: 'var(--color-text-primary)' }}
                    ...
                    {categoryData.length > 0 ? (
                        <ResponsiveContainer width="100%" height={250}>
                            <BarChart data={categoryData}>
                                ...
                                <YAxis stroke="var(--color-text-secondary)" fontSize={11} tickFormatter={v => `₺${(v / 1000).toFixed(0)}k`} />
                                <Tooltip contentStyle={{ background: 'var(--color-surface-dark)', border: '1px solid var(--color-border)', borderRadius: '8px', fontSize: '12px', color: 'var(--color-text-primary)' }}
