...
const menuItems = [
    ...
    { id: 'repairParts', label: 'Parça Stoğu', icon: 'construction' },
    ...
    { id: 'appointments', label: 'Randevu Takvimi', icon: 'calendar_month' },
    { id: 'warranty', label: 'Garanti Takibi', icon: 'verified_user' },
    { id: 'aiForecast', label: 'AI Tahmin', icon: 'auto_awesome' },
    { id: 'backup', label: 'Veri Yedekleme', icon: 'cloud_sync' },
                    ...
                    {menuItems.map(item => (
                        <button
                            ...
                            className={`menu-item w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left relative ${activeView === item.id
                                ...
                                : 'text-slate-500 hover:bg-surface-hover group'
                                }`}
                        >
                            {activeView === item.id && (
